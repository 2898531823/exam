...
/**
 * @className: com.wsy.exam.handler-> GlobalExceptionHandler
 * @description: GlobalExceptionHandler
 * @author: wsy
 * @createDate: 2022-04-21 13:45
 * @version: 1.0
 */
...
public class GlobalExceptionHandler
{
    ...
    public R handleAccessDeniedException(AccessDeniedException e, HttpServletRequest request)
    {
        ...
        return R.error().code(403).message("没有权限，请联系管理员授权");
    }
    ...
    public R handleServiceException(ServiceException e, HttpServletRequest request)
    {
        ...
        return StringUtils.isNotNull(code) ? R.error().code(code).message(e.getMessage()) : R.error().message(e.getMessage());
    }
